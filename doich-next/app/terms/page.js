...
const MN = {
  ...
  updated: 'Хамгийн сүүлд шинэчлэгдсэн: 2026 оны 6-р сарын 9',
  toggle:  'English',
  ...
  sections: [
    ...
    { h: '5. Гишүүнчлэл ба Төлбөр', items: ['Үнэгүй хувилбар нь хэл сурах үндсэн боломжуудыг ямар нэгэн төлбөргүйгээр ашиглах эрхийг олгоно.','Pro төлөвлөгөө нь нэмэлт боломжуудыг нээх бөгөөд дараах хугацааны сонголттой байна: 1 сар — 12,900₮ · 3 сар — 32,900₮ · 12 сар — 99,900₮','Pro эрхийг гараар худалдаж авна. Автоматаар сунгагдахгүй тул төлбөр төлсөн хугацаа дуусахад таны Pro төлөвлөгөө зүгээр л дуусгавар болно.','Та хэдийд ч шинээр хугацаа худалдан авч, Pro эрхээ сунгах боломжтой.','Хуулиар шаардсанаас бусад тохиолдолд төлбөрийг буцаан олгохгүй.'] },
    ...
    { h: '10. Цуцлах ба Буцаан олголт', items: ['Pro гишүүнчлэл автоматаар сунгагдахгүй тул тусгайлан цуцлах шаардлагагүй — төлбөр төлсөн хугацаа дуусмагц Pro эрх аяндаа дуусгавар болно.','Pro идэвхжүүлсний дараа буцаан олголт хийхгүй. Техникийн доголдол эсвэл давхар төлбөр тооцогдсон тохиолдолд doichapp@gmail.com хаягаар 7 хоногийн дотор холбогдон мэдэгдэнэ үү.','Та хэдийд ч бидэнтэй холбогдон бүртгэлээ устгуулах боломжтой. Бүртгэл устгасан тохиолдолд үлдэх Pro хугацааны нөхөн олговор олгохгүй.','Эдгээр нөхцөлийг зөрчсөн бүртгэлийг түр хугацаагаар зогсоох эсвэл бүрмөсөн устгах эрхийг бид өөртөө үлдээж байна.'] },
...
const EN = {
  ...
  sections: [
    ...
    { h: '10. Cancellation & Refunds', items: ['Pro subscriptions do not auto-renew, so no cancellation is needed — your Pro access simply expires at the end of the paid period.','All purchases are non-refundable after activation. In the event of a technical error or duplicate charge, contact us at doichapp@gmail.com within 7 days.','You may delete your account at any time by contacting us. Deleting your account does not entitle you to a refund for any remaining Pro period.','We reserve the right to suspend or terminate accounts that violate these terms.'] },

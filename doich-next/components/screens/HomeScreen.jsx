  ...
  return (
    <div className="af">
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ color: t.textSoft, fontSize: 12, fontWeight: 600, marginBottom: 2 }}>{greeting}</div>
      ...
      {/* Daily Practice — gold flat button */}
      <button onClick={() => !isDoneToday && setTab('daily')}
        ...
        <div style={{ textAlign: 'left' }}>
          <div style={{ fontWeight: 800, fontSize: 15, color: isDoneToday ? t.textMid : t.pinkBtnText }}>
            Өдөр тутмын дасгал
          </div>
      ...
      {state.learnedWords.length > 0 && (
        <button onClick={() => setTab('review')} className="au"
          style={{
            ...
            background: t.bgCard,
            border: `2px solid ${due > 0 ? t.pink : t.border}`,
          }}>
